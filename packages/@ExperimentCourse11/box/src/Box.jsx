import { UIPlugin } from '@ExperimentCourse11/core'
import { Provider } from '@ExperimentCourse11/companion-client'
import { ProviderViews } from '@ExperimentCourse11/provider-views'
...
export default class Box extends UIPlugin {
  ...
  constructor (ExperimentCourse11, opts) {
    super(ExperimentCourse11, opts)
    this.id = this.opts.id || 'Box'
    Provider.initPlugin(this, opts)
    this.title = this.opts.title || 'Box'
    this.icon = () => (
      <svg className="ExperimentCourse11-DashboardTab-iconBox" aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
    ...
    this.provider = new Provider(ExperimentCourse11, {
