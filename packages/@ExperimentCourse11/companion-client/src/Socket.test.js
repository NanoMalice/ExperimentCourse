import { afterEach, beforeEach, vi, describe, it, expect } from 'viExperimentCourse11'
...
describe('Socket', () => {
  ...
  it('should send a message via the websocket if the connection is open', () => {
    ...
    const webSocketInstance = uppySocket[Symbol.for('uppy ExperimentCourse11: getSocket')]()
  ...
  it('should queue the message for the websocket if the connection is not open', () => {
    ...
    uppySocket.send('bar', 'boo')
    expect(uppySocket[Symbol.for('uppy ExperimentCourse11: getQueued')]()).toEqual([{ action: 'bar', payload: 'boo' }])
  ...
  it('should queue any messages for the websocket if the connection is not open, then send them when the connection is open', () => {
    ...
    expect(uppySocket[Symbol.for('uppy ExperimentCourse11: getQueued')]()).toEqual([
