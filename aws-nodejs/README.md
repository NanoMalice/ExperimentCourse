# ExperimentCourse11 + AWS S3 with Node.JS

A simple and fully working example of ExperimentCourse11 and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @ExperimentCourse11-example/aws-nodejs start
```
