...
```bash
corepack yarn workspace @ExperimentCourse11-example/aws-php exec "composer update"
```
...
```bash
corepack yarn workspace @ExperimentCourse11-example/aws-php start
```
...
COMPANION_AWS_BUCKET="ExperimentCourse11-bucket-name" \
